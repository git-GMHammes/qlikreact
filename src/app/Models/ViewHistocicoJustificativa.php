...
class ViewHistocicoJustificativa extends Model
{ // src\app\Models\ViewHistocicoJustificativa.php

    protected $DBGroup = GRUPO_DB_CONFIG;

    protected $table = 'v_justification_history';
    ...
    {
        exit('403 Forbidden - Table access is forbidden');
        try {
