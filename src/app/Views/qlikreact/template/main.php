...
<head>
    ...
    <!-- Incluindo o CKEditor via CDN -->
    <script src="<?php echo base_url() . $caminho_ckeditor4; ?>"></script>
...
<body>
    ...
    <footer>
        ...
        <?php
        // include_once('script/monitora_login.php');
        // include_once(ROOTPATH . 'app/Views/cookie/main.php');
        // include_once('script/ckeditor.php');
        // include_once('script/upload_video.php');
        // include_once('script/util/reload_js.php');
        // include_once('script/abrir_popup.php');
